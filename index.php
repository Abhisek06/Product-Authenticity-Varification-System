  ...
  <center>
    ...
    <div style="width: 100%">
      ...
      <div class="loginformcard" id="card1">
            <h4> Welcome to AuthIt - The DAPP</h4>
            <p style="max-width: 80%;">
            AuthIt is a Decentralized Application that is useful for the customer to detect fake products in the supply chain. Customers can scan QR codes assigned to a product and can get all the information like transaction history, current owner based on which end-user can check whether the product is genuine or not.
            </p>
